# Workflow: Open_OUIdiscovery_canon


# Please edit the following path to point to the correct location. #D\:\\vasv1101\\Documents_discC\\msfragger_pride_reanalysis\\concatenated-fastas\\Human_2023_01_canonical_ionbot_db\\concat.fasta
# In Windows, please replace single '\' with '\\'
database.db-path=/mnt/d/vasv1101/Documents_discC/msfragger_pride_reanalysis/concatenated-fastas/Human_2023_01_canonical_ionbot_db/concat.fasta 

crystalc.run-crystalc=false
database.decoy-tag=decoy
...
diann.quantification-strategy-2=1
...
msfragger.table.var-mods=15.9949,M,true,3; 42.0106,[^,true,1; 57.0215,C,true,3
...
peptide-prophet.cmd-opts=--nonparam --expectscore --decoyprobs --masswidth 1000.0 --clevel -0 --enzyme stricttrypsin
...
phi-report.filter=--mapmods --psm 1 --pep 1 --prot 1
phi-report.pep-level-summary=true
phi-report.print-decoys=true
phi-report.prot-level-summary=true
phi-report.remove-contaminants=false
phi-report.run-report=true
protein-prophet.cmd-opts=--maxppmdiff 2000000
protein-prophet.run-protein-prophet=true
ptmprophet.cmdline=NOSTACK KEEPOLD STATIC M\:15.9949,n\:42.0106,C\:57.0215 MINPROB\=0.0 MAXTHREADS\=10
...
ptmshepherd.diagmine_minPeps=1
...
ptmshepherd.peakpicking_minPsm=1
...
ptmshepherd.spectra_maxfragcharge=3
...
workflow.description=<p style\="margin-top\: 0in">Open search workflow for PTM analysis (\!modified default parameters of FragPipe Open.workflow\!). PeptideProphet with extended mass model. PTM-Shepherd for mass shift summarization.Database - canon.</p>
