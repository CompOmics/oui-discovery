# Workflow: Open_OUIdiscovery_openprot_batch


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/mnt/d/vasv1101/Documents_discC/msfragger_pride_reanalysis/concatenated-fastas/20241102-openprot-database_ionbot_db/concat.fasta
...
workflow.description=<p style\="margin-top\: 0in">Open search workflow for PTM analysis (\!modified default parameters of FragPipe Open.workflow\!). PeptideProphet with extended mass model. PTM-Shepherd for mass shift summarization.Database - openprot.Combine files.</p>
