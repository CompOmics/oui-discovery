# Workflow: Open_OUIdiscovery_trembl_batch


# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'
database.db-path=/mnt/d/vasv1101/Documents_discC/msfragger_pride_reanalysis/concatenated-fastas/Human_2023_01_trembl_ionbot_db/concat_maped.fasta
...
workflow.description=<p style\="margin-top\: 0in">Open search workflow for PTM analysis (\!modified default parameters of FragPipe Open.workflow\!). PeptideProphet with extended mass model. PTM-Shepherd for mass shift summarization.Database - trembl.Combine files.</p>
