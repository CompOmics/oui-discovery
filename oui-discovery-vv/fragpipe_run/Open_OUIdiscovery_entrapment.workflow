# Loaded from: C:\Users\vasv1101\AppData\Local\Temp\fragpipe\workflows\Open_OUIdiscovery_entrapment.workflow
...
msfragger.misc.fragger.enzyme-dropdown-1=nocleavage
msfragger.misc.fragger.enzyme-dropdown-2=nocleavage
...
msfragger.search_enzyme_name_1=nocleavage
msfragger.search_enzyme_name_2=nocleavage
...
peptide-prophet.cmd-opts=--nonparam --expectscore --decoyprobs --masswidth 1000.0 --clevel -0
...
workflow.description=<p style\="margin-top\: 0in">Open search workflow for PTM analysis (\!modified default parameters of FragPipe Open.workflow\!). PeptideProphet with extended mass model. PTM-Shepherd for mass shift summarization.</p>
